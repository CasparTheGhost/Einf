...
//Separiert die Binärzahl nach 4 Bits mit einem Leerzeichen
...
//argument_count = Anzahl an Argumenten, die der main(...) übergeben werden.
//args[] String Array gefüllt mit Argumenten
